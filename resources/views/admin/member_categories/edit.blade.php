...
@section('content')
    ...
    <div class="page-content">
        ...
        @endif
        <form method="post" action="{{url('/admin/member_categories/'.$member_category->id)}}" enctype="multipart/form-data">
            @method('PATCH')
            @csrf
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 mb-3">
                    ...
                    <input id="name" class="form-control" name="name" value="{{$member_category->name}}" type="text">
                </div>
                <div class="col-md-6 col-lg-6 mb-3">
                    <label for="name" class="form-label">Category description</label>
                    <textarea class="form-control editor" name="description">
                        {{$member_category->description}}
                    </textarea>
                </div>
                <div class="col-md-6 col-lg-6 mb-3">
                    <label for="name" class="form-label">Category benefits</label>
                    <textarea  class="form-control editor1" name="benefits">
                         {{$member_category->benefits}}
                    </textarea>
                </div>
            </div>
            <div class="row">
