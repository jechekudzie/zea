...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
            <div>
                <h4 class="mb-3 mb-md-0">Subscribers</h4>
            </div>
            <div class="d-flex align-items-center flex-wrap text-nowrap">
                <a href="{{url('/admin/subscribers/create')}}" class="btn btn-outline-primary btn-icon-text me-2 mb-2 mb-md-0">
                            ...
                            <table id="dataTableExample" class="table">
                                ...
                                @foreach($subscribers as $subscribe)
                                    <tr>
                                        ...
                                        <td><a href="{{url('/admin/$subscribers/'.$subscribers->id.'/edit')}}">Edit</a></td>
                                        <td><a href="{{url('/admin/$subscribers/'.$subscribers->id)}}">View</a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
