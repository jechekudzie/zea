...
<div id="wrapper" class="clearfix">
                                            ...
                                            <div  class="megamenu megamenu-fullwidth megamenu-position-left">
                                                <div class="megamenu-row">
                                                    ...
                                                    <div  class="col3">
                                                        <ul class="list-unstyled list-dashed">
                                                            <li class="menu-item">
                                                                <a class="tm-submenu-title" href="#"><span>Single Layouts</span></a>
                                                                <ul class="list-unstyled">
                                            ...
                                            <div  class="megamenu megamenu-fullwidth megamenu-position-left">
                                                <div class="megamenu-row">
                                                    ...
                                                    <div  class="col3">
                                                        <ul class="list-unstyled list-dashed">
                                                            <li class="menu-item">
                                                                <a class="tm-submenu-title" href="#"><span>Portfolio Layouts</span> <span class="badge bg-danger">New</span></a>
                                                                <ul class="list-unstyled">
                                            ...
                                            <div  class="megamenu megamenu-fullwidth megamenu-position-left">
                                                <div class="megamenu-row">
                                                        ...
                                                        <div class="widget">
                                                            ...
                                                            <ul class="product_list_widget">
                                                                <li class="mb-20">
                                                                    <div class="product-left">
                                                                        <a class="p-0" href="shop-product-details.html">
                                                                            <img width="120" height="120" src="images/shop/product.jpg" class="thumbnail" alt="">
                                                                        </a>
                                                                    </div>
                                                                ...
                                                                <li class="mb-20">
                                                                    <div class="product-left">
                                                                        <a class="p-0" href="shop-product-details.html">
                                                                            <img width="120" height="120" src="images/shop/product2.jpg" class="thumbnail" alt="">
                                                                        </a>
                                                                    </div>
                                                                    <div class="product-right">
                                                    ...
                                                    <div class="col5">
                                                        ...
                                                        <img class="img-fullwidth" src="images/shop/portfolio-big1.jpg" alt="">
                                                    </div>
                                                    <div class="col3">
                                                        <ul class="list-unstyled list-dashed">
                                                            <li>
    ...
    <div class="main-content-area">
                ...
                <div class="section-content">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-md-12 col-lg-8 col-xl-8">
                            <h2 class="text-white text-uppercase font-size-84 font-weight-800 pl-10 mt-0 mb-60 line-height-1"><span class="text-theme-colored1">Study</span>press</h2>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="tm-sc-icon-box icon-box icon-left tm-iconbox-icontype-font-icon text-left iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-left mb-60">
                                        <div class="icon-box-wrapper">
                                            <a class="icon icon-type-font-icon icon-circled icon-dark icon-theme-colored1">
                                                <i class="flaticon-medical-ambulance14"></i></a>
                                            <div class="icon-text">
                                                <p class="text-white mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore atque officiis maxime suscipit expedita obcaecati nulla</p>
                                            </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                            <form id="home_appointment_form" name="home_appointment_form" class="booking-form form-home bg-white p-30 mt-md-40" method="post" action="includes/appointment.php" novalidate="novalidate">
                                ...
                                <div class="mb-3 mb-0 mt-20">
                                    ...
                                    <button type="submit" class="btn btn-theme-colored1 text-white btn-block" data-loading-text="Please wait...">Submit Request</button>
                                </div>
                            </form>
                    ...
                    <div class="row row-o-equal-height">
                        <div class="bg-theme-colored1 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                            <div class="tm-sc-icon-box icon-box icon-left tm-iconbox-icontype-font-icon text-left iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-left p-30">
                                <div class="icon-box-wrapper">
                                    <a class="icon icon-type-font-icon icon-default text-white"> <i class="fa fa-certificate mt-10 font-size-36"></i> </a>
                                    <div class="icon-text">
                        ...
                        <div class="bg-theme-colored1 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                            <div class="tm-sc-icon-box icon-box icon-left tm-iconbox-icontype-font-icon text-left iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-left p-30">
                                <div class="icon-box-wrapper">
                                    <a class="icon icon-type-font-icon icon-default text-white"> <i class="fa fa-map-marker mt-10 font-size-36"></i> </a>
                                    <div class="icon-text">
                        ...
                        <div class="bg-theme-colored1 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                            <div class="tm-sc-icon-box icon-box icon-left tm-iconbox-icontype-font-icon text-left iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-left p-30">
                                <div class="icon-box-wrapper">
                                    <a class="icon icon-type-font-icon icon-default text-white"> <i class="fa fa-phone-alt mt-10 font-size-36"></i> </a>
                                    <div class="icon-text">
                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-5 col-xl-5">
                            <h2 class="text-uppercase line-height-1 font-weight-600 mt-0 line-bottom line-bottom-theme-colored1">World Best University</h2>
                            <h5 class="text-theme-colored2 mb-20">Lorem ipsum dolor sit amet consectetur adipisicing elit Perferendis repudiandae nostrum quibusdam! elit Perferendis repudiandae</h5>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore atque officiis maxime suscipit expedita obcaecati nulla in ducimus iure quos quam recusandae dolor quas et perspiciatis voluptatum accusantium delectus nisi reprehenderit, eveniet fuga modi pariatur.</p>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7">
                            <div class="row mt-md-60">
                                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 ">
                                    ...
                                    <a class="text-theme-colored1 font-size-13 font-weight-600 mb-md-30 display-inline-block" href="#">View Details →</a>
                                </div>
                                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 ">
                                    <div class="mt-sm-40">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 ">
                                    ...
                                    <p class="mb-10">Lorem ipsum dolor sit amet, consectetur.</p>
                                    <a class="text-theme-colored1 font-size-13 font-weight-600" href="#">View Details →</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="owl-carousel tm-owl-carousel-4col" data-dots="true">
                                <div class="campaign bg-white mb-30">
                                    ...
                                    <div class="campaign-details clearfix p-15 pt-10 pb-10">
                                        ...
                                        <p>Lorem ipsum dolor adipisicing elit. Praesent quossit sit amet consect adipisicing elit quossit <a class="text-theme-colored2 ml-10" href="#"> →</a></p>
                                        <div class="campaign-bottom border-top clearfix pt-10 pb-10 mt-30 align-items-center">
                                            <ul class="list-inline font-weight-600 float-start pr-0 mt-15">
                                                <li class="text-theme-colored1 pr-0 mr-10">Couse Fee: <span class="text-theme-colored2">$890</span></li>
                                            </ul>
                                            <a class="btn btn-xs btn-theme-colored2 font-weight-600 font-11 float-end flip mt-10" href="#">Read More</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="campaign bg-white mb-30">
        ...
        <!-- Section: Funfacts -->
        <section class="layer-overlay overlay-theme-colored2-9 bg-no-repeat bg-pos-center-center" data-tm-bg-img="images/bg/bg2.jpg">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3 col-xl-3">
                                <div class="funfact-item text-center mb-md-60">
                                    ...
                                    <h2 data-animation-duration="2000" data-value="5248" class="text-white counter animate-number mt-0 mb-10">0</h2>
                            ...
                            <div class="col-md-6 col-lg-3 col-xl-3">
                                <div class="funfact-item text-center mb-md-60">
                                    ...
                                    <h2 data-animation-duration="2000" data-value="645" class="text-white counter animate-number mt-0 mb-10">0</h2>
                            ...
                            <div class="col-md-6 col-lg-3 col-xl-3">
                                <div class="funfact-item text-center mb-sm-60">
                                    ...
                                    <h2 data-animation-duration="2000" data-value="248" class="text-white counter animate-number mt-0 mb-10">0</h2>
                            ...
                            <div class="col-md-6 col-lg-3 col-xl-3">
                                <div class="funfact-item text-center">
                                    ...
                                    <h2 data-animation-duration="2000" data-value="24" class="text-white counter animate-number mt-0 mb-10">0</h2>
                                            ...
                                            <div class="isotope-item-inner">
                                                <div class="tm-gallery">
                                                    <div class="tm-gallery-inner">
                                                        <div class="thumb">
                                                            <a href="#">
                                                                <img width="672" height="448" src="images/gallery/1.jpg" class="" alt="" />
                                                            </a>
                                                        </div>
                                                                ...
                                                                <div class="tm-gallery-content-inner">
                                                                    <div class="icons-holder-inner">
                                                                        <div class="styled-icons icon-dark icon-circled icon-theme-colored1">
                                                                            <a class="lightgallery-trigger styled-icons-item" data-exthumbimage="images/gallery/1.jpg" data-src="images/gallery/1.jpg" title="Gallery 1" href="images/gallery/1.jpg"><i class="fa fa-plus"></i></a>
                                            ...
                                            <div class="isotope-item-inner">
                                                <div class="tm-gallery">
                                                    <div class="tm-gallery-inner">
                                                        <div class="thumb">
                                                            <a href="#">
                                                                <img width="672" height="448" src="images/gallery/2.jpg" class="" alt="" />
                                                            </a>
                                                        </div>
                                                        <div class="tm-gallery-content-wrapper">
                                                            <div class="tm-gallery-content">
                                                                <div class="tm-gallery-content-inner">
                                                                    <div class="icons-holder-inner">
                                                                        <div class="styled-icons icon-dark icon-circled icon-theme-colored1">
                                                                            <a class="lightgallery-trigger styled-icons-item" data-exthumbimage="images/gallery/2.jpg" data-src="images/gallery/2.jpg" title="Gallery 2" href="images/gallery/2.jpg"><i class="fa fa-plus"></i></a>
                                            ...
                                            <div class="isotope-item-inner">
                                                <div class="tm-gallery">
                                                    <div class="tm-gallery-inner">
                                                        <div class="thumb">
                                                            <a href="#">
                                                                <img width="672" height="448" src="images/gallery/3.jpg" class="" alt="" />
                                                            </a>
                                                        </div>
                                                        <div class="tm-gallery-content-wrapper">
                                                            <div class="tm-gallery-content">
                                                                <div class="tm-gallery-content-inner">
                                                                    <div class="icons-holder-inner">
                                                                        <div class="styled-icons icon-dark icon-circled icon-theme-colored1">
                                                                            <a class="lightgallery-trigger styled-icons-item" data-exthumbimage="images/gallery/3.jpg" data-src="images/gallery/3.jpg" title="Gallery 3" href="images/gallery/3.jpg"><i class="fa fa-plus"></i></a>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="event-details p-15 pt-0 pb-0">
                                            <h5 class="media-heading text-uppercase mt-0 mb-0 mt-sm-15">Upcoming Event Title</h5>
                ...
                <div class="section-content">
                    <div class="row justify-content-md-center">
                        <div class="col-md-12 col-lg-8 col-xl-8">
                            ...
                            <div class="tm-sc-testimonials tm-sc-testimonials-carousel testimonial-style2-centered-aligned owl-dots-light-skin owl-dots-center testimonial-has-quote-icon">
                                <div class="owl-carousel owl-theme tm-owl-carousel-1col" data-nav="true" data-dots="true" data-autoplay="true" data-loop="true" data-duration="6000" data-smartspeed="300" data-margin="30" data-stagepadding="0">
                                    <div class="tm-carousel-item">
                                        <div class="tm-testimonial">
                                            <div class="testimonial-inner">
                                                <div class="testimonial-text-holder">
                                                    <div class="testimonial-image-holder mb-30">
                                                        <div class="author-thumb"> <img width="75" height="75" src="images/testimonials/3.jpg" class="img-thumbnail rounded-circle" alt=""/>
                                                        </div>
                                                    </div>
                                                    <div class="text-white author-text"> I feel very happy and be proud to connect with this industry. I presume this is a very productive and professional industry. I wish very good luck & success for this industry</div>
                                                ...
                                                <div class="testimonial-author-details">
                                                    <div class="testimonial-author-info-holder">
                                                        ...
                                                        <span class="text-white job-position">Designer</span> <a class="company-url" href="#"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tm-carousel-item">
                                        <div class="tm-testimonial">
                                            <div class="testimonial-inner">
                                                <div class="testimonial-text-holder">
                                                    <div class="testimonial-image-holder mb-30">
                                                        <div class="author-thumb"> <img width="75" height="75" src="images/testimonials/1.jpg" class="img-thumbnail rounded-circle" alt=""/>
                                                        </div>
                                                    </div>
                                                    <div class="text-white author-text"> I feel very happy and be proud to connect with this industry. I presume this is a very productive and professional industry. I wish very good luck & success for this industry</div>
                                                    <div class="star-rating">
                                    ...
                                    <div class="tm-carousel-item">
                                        <div class="tm-testimonial">
                                            <div class="testimonial-inner">
                                                <div class="testimonial-text-holder">
                                                    <div class="testimonial-image-holder mb-30">
                                                        <div class="author-thumb"> <img width="75" height="75" src="images/testimonials/2.jpg" class="img-thumbnail rounded-circle" alt=""/>
                                                        </div>
                                                    </div>
                                                    <div class="text-white author-text"> I feel very happy and be proud to connect with this industry. I presume this is a very productive and professional industry. I wish very good luck & success for this industry</div>
                                                    <div class="star-rating">
